#include "utility.hpp"
#include "lio_sam_go2/msg/cloud_info.hpp"
#include "lio_sam_go2/srv/save_map.hpp"
...
public:
    ...
    rclcpp::Service<lio_sam_go2::srv::SaveMap>::SharedPtr srvSaveMap;
    rclcpp::Subscription<lio_sam_go2::msg::CloudInfo>::SharedPtr subCloud;
    rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr subGPS;
    rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr subLoop;

    std::deque<nav_msgs::msg::Odometry> gpsQueue;
    lio_sam_go2::msg::CloudInfo cloudInfo;
    ...
    mapOptimization(const rclcpp::NodeOptions & options) : ParamServer("lio_sam_mapOptimization", options)
    {
        ...
        subCloud = create_subscription<lio_sam_go2::msg::CloudInfo>(
        ...
        auto saveMapService = [this](const std::shared_ptr<rmw_request_id_t> request_header, const std::shared_ptr<lio_sam_go2::srv::SaveMap::Request> req, std::shared_ptr<lio_sam_go2::srv::SaveMap::Response> res) -> void {
            (void)request_header;
        ...
        srvSaveMap = create_service<lio_sam_go2::srv::SaveMap>("lio_sam/save_map", saveMapService);
    ...
    void laserCloudInfoHandler(const lio_sam_go2::msg::CloudInfo::SharedPtr msgIn)
    {
        // extract time stamp
