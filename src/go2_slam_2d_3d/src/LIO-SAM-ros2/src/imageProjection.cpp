...
public:
    ...
    bool cachePointCloud(const sensor_msgs::msg::PointCloud2::SharedPtr& laserCloudMsg)
    {
        ...
        // Ouster organized clouds are not dense (no-return points are NaN).
        // Remove NaN points instead of aborting; ring-based projection still works.
        if (laserCloudIn->is_dense == false)
        {
            std::vector<int> nan_indices;
            pcl::removeNaNFromPointCloud(*laserCloudIn, *laserCloudIn, nan_indices);
