...
public:
    ...
    rclcpp::Subscription<lio_sam_go2::msg::CloudInfo>::SharedPtr subLaserCloudInfo;

    rclcpp::Publisher<lio_sam_go2::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    {
        subLaserCloudInfo = create_subscription<lio_sam_go2::msg::CloudInfo>(
            "lio_sam/deskew/cloud_info", qos,
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<lio_sam_go2::msg::CloudInfo>(
